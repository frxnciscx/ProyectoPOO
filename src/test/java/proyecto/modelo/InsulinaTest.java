...
class InsulinaTest {
    ...
    void testSePuedeTomar() {
        Insulina ins = new Insulina("Rápida", 5, 10, "01/01/2030", 70.0);

        //caso 1: glucosa suficiente(100)->deberia dejar tomar
        assertTrue(ins.sePuedeTomar(100.0), "Debería permitir tomar con glucosa 100");

        //caso 2: glucosa muy baja (50)->NO deberia dejar tomar
        assertFalse(ins.sePuedeTomar(50.0), "NO debería permitir tomar con glucosa 50");

        //caso 3: glucosa exacta (70)->deberia dejar
        assertTrue(ins.sePuedeTomar(70.0), "Debería permitir tomar con glucosa justa");
    }
